...
export declare type FramesLanguages = 'EN-GB' | 'ES-ES' | 'FR-FR' | 'DE-DE' | 'KR-KR' | 'IT-IT' | 'NL-NL';
export declare type FrameElementIdentifer = 'card-number' | 'expiry-date' | 'cvv';
export declare type PaymentMethod = 'Visa' | 'Mastercard' | 'American Express' | 'Diners Club' | 'Maestro' | 'Discover';
...
export declare type PreferredScheme = 'mastercard' | 'visa' | 'cartes_bancaires';
...
export interface FramesAppendedProps extends FramesProps {
    ...
    addEventHandler: (event: FramesEvents[keyof FramesEvents], eventHandler: (event: any) => void) => void;
    removeEventHandler: (event: FramesEvents[keyof FramesEvents], eventHandler: (event: any) => void) => boolean;
